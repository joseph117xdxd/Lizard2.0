        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">
              ¿No encontraste ninguna API de panel de administración gratuita?
            </h2>
            <p className="text-xl text-gray-400">
            Lizard 2.0 esta dirigido para los proyectos en los cuales se
              necesite la gestion de usuarios y modulos en formato JSON y JWT.
              Navega por todo el sitio para conocer nuestros ejemplos.
            </p>
          </div>
          ...
          >
            ...
            >
              ...
              <h4 className="h4 mb-2">Manejo de errores</h4>
              <p className="text-lg text-gray-400 text-center">
                La aplicación responde correctamente a las solicitudes de errores, esto podrá encontrarse en la documentación.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Errores descriptivos</h4>
              <p className="text-lg text-gray-400 text-center">
                Los errores que puedan aparecer te ayudarán a entender mejor el problema.
              </p>
            </div>
            ...
            >
              ...
              <h4 className="h4 mb-2">Ejemplos de solicitudes</h4>
              <p className="text-lg text-gray-400 text-center">
                Esta documentación cuenta con ejemplos de solicitudes y respuestas para cada endpoint, mostrandolos en formato JSON.
              </p>
            </div>
          </div>
        </div>
